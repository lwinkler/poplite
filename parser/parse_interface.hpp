...
#define POP_METH_(_calli_, _callb_, _ret_, _meth_, ...) inline _ret_ _meth_(APPLY(PAIR, __VA_ARGS__)){sync<_ret_ APPLYC(STRIP1, __VA_ARGS__)>(static_cast<int>(CAT3(broker::_parclass_,_method_ids::_meth_,__COUNTER__)) APPLYC(STRIP2, __VA_ARGS__));}
